...
7. Fetch each product line and add a column to those product line showing "Good", and "Bad". Good if it's greater than average sales
...
For the rest of the code, check the [SQL_queries.sql](https://github.com/SaumyadeepRay/Walmart-Sales-Analysis/blob/main/salesDataWalmart.sql) file
